...
const CTA = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-brand-pink to-brand-pink-light">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-6">
              <a 
                ...
                className="inline-flex items-center space-x-3 bg-white text-brand-pink px-10 py-5 rounded-full font-open-sans font-bold text-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-bounce-subtle"
              >
